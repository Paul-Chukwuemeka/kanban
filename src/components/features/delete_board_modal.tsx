...
const Deleteboardmodal = ({ onClose }: DeleteboardmodalProps) => {
  ...
  return (
    ...
    >
      <div
        className={`p-10 rounded-xl flex flex-col w-[450px] space-y-4 ${
      ...
      >
        ...
        <p
          className={`text-[#7C8CA4] ${
            darkMode ? "text-[#7C8CA4]" : "text-[#7C8CA4]"
          }`}
        >
        ...
        <div className="flex space-x-8 justify-between text-lg font-bold">
          ...
          <button
            className={`w-1/2  bg-[#b5c0d2] cursor-pointer border-none p-3 py-2 rounded-full ${
